 ...
 * # Pra que serve?
 * - Criar o .env a partir do .env.example (com JWT_SECRET e VISITOR_SALT aleatórios) se ele não existir
...
// Variáveis que não podem ficar com o valor de exemplo: cada .env novo ganha um valor só dele
const GENERATED_SECRETS = ["JWT_SECRET", "VISITOR_SALT"]

// Primeira vez rodando o projeto: copia o modelo e troca os segredos por valores de verdade
function ensureEnvFile() {
  ...
  console.log("📝 Criei o .env a partir do .env.example (com segredos novos)")
